...
print("Type your answer. Stop when you feel ready.\n")
time.sleep(2)
...
print(f"  Stop Warnings         : {stop_warnings} / {max_warnings}")
print(f"  Avg Response Time     : {average_time} sec")
